...
public interface RSocketRequester extends Disposable {
	 ...
	 * {@link Builder#dataMimeType(MimeType)} while on the
	 ...
	 * at connection time. On the client side this is configured via
	 * {@link Builder#metadataMimeType(MimeType)} while on the
	 * server side it's obtained from the {@link ConnectionSetupPayload}.
	 */
	...
	interface Builder {
		 ...
		 * <p>By default this is not set.
		 */
		Builder setupRoute(String route, Object... routeVars);
		 ...
		 * to a {@link Publisher} via {@link ReactiveAdapterRegistry}.
		 */
		Builder setupMetadata(Object value, @Nullable MimeType mimeType);
		 ...
		 */
		Builder rsocketStrategies(@Nullable RSocketStrategies strategies);
		 ...
		 */
		Builder apply(Consumer<Builder> configurer);
