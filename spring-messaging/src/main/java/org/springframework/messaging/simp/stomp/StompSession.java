...
public interface StompSession {
	 ...
	 * the {@link Receiptable Receiptable} returned from the
	...
	interface Receiptable {
		 ...
		 * @throws IllegalArgumentException if the receiptId is {@code null}
		 */
		 ...
		 * @throws IllegalArgumentException if the receiptId is {@code null}
		 * @see StompClientSupport#setReceiptTimeLimit(long)
		 */
