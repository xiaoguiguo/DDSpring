...
public abstract class EntityManagerFactoryAccessor implements BeanFactoryAware {
	 ...
	 * @see javax.persistence.EntityManagerFactory#createEntityManager(Map)
	 */
	 ...
	 * @see EntityManagerFactoryUtils#getTransactionalEntityManager(javax.persistence.EntityManagerFactory, Map)
	 */
	@Nullable
