...
public class XsltView extends AbstractUrlBasedView {
	 ...
	 * @param transformer the target transformer
	 * @see org.springframework.util.xml.TransformerUtils#enableIndenting(Transformer)
	 * @see org.springframework.util.xml.TransformerUtils#disableIndenting(Transformer)
	 */
